  ...
  const addtocarthandler= ()=>{
    ...
    return ( 
        ...
        <div className="special-Offer-page-img-wrapper">
          <img src={images2} className="special-offer-page-img"
        ...
        <div className="special-offer-page-info">
          ...
          <div className="special-offer-page-add-to-cart">
            ...
            <button onClick={addtocarthandler} className="add-to-cart-btn">اضافه الى سله التسوق</button>
          </div>
        </div>
      </div>
     );
...
export default Samsungfunction;